...
// HeyGen stock avatar used when no user photo is provided
const HEYGEN_DEFAULT_AVATAR_ID = "Daisy-inskirt-20220818";
...
async function generateHeyGenVideo(
  ...
  if (avatarPhotoPath) {
    ...
    character = { type: "avatar", avatar_id: HEYGEN_DEFAULT_AVATAR_ID };
  }
