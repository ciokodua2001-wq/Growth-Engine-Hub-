    ...
    <AnimatePresence>
      {open && (
        <>
          ...
          >
            <div
              className="w-full max-w-md rounded-2xl border border-white/10 p-8 pointer-events-auto"
            ...
            >
              ...
              <p className="text-white/50 text-sm mb-6">
                {limit && limitLabel
                  ? `Your free trial includes ${limit} ${limitLabel}. Upgrade to unlock unlimited access across all modules.`
                  : "Your free trial has reached its limit. Upgrade to a paid plan to keep going."}
              </p>
