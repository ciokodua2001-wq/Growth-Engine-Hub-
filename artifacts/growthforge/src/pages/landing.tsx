...
const FAQ = [
  ...
  { q: "What plans are available?", a: "GrowthForge offers four paid tiers: Starter ($39/mo, 1 project, 4 min video), Get-Going ($99/mo, 3 projects, 8+1 min 1080p+4K video), Growth ($299/mo, 6 projects, 25+4 min video), and Agency ($799/mo, 20 projects, 60+10 min video). All include a 14-day free trial. Paid billing is launching soon — join the early access waitlist for an exclusive launch discount." },
